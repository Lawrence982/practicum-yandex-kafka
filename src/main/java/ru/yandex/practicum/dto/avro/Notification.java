 ...
 */
package ru.yandex.practicum.dto.avro;
...
public class Notification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4962232531216925085L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Notification\",\"namespace\":\"ru.yandex.practicum.dto.avro\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Notification(java.lang.String id, java.lang.String name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static ru.yandex.practicum.dto.avro.Notification.Builder newBuilder() {
    return new ru.yandex.practicum.dto.avro.Notification.Builder();
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static ru.yandex.practicum.dto.avro.Notification.Builder newBuilder(ru.yandex.practicum.dto.avro.Notification.Builder other) {
    if (other == null) {
      return new ru.yandex.practicum.dto.avro.Notification.Builder();
    } else {
      return new ru.yandex.practicum.dto.avro.Notification.Builder(other);
    }
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static ru.yandex.practicum.dto.avro.Notification.Builder newBuilder(ru.yandex.practicum.dto.avro.Notification other) {
    if (other == null) {
      return new ru.yandex.practicum.dto.avro.Notification.Builder();
    } else {
      return new ru.yandex.practicum.dto.avro.Notification.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Notification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ru.yandex.practicum.dto.avro.Notification.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ru.yandex.practicum.dto.avro.Notification other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.yandex.practicum.dto.avro.Notification.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.yandex.practicum.dto.avro.Notification.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.yandex.practicum.dto.avro.Notification.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.yandex.practicum.dto.avro.Notification.Builder clearName() {
      name = null;
